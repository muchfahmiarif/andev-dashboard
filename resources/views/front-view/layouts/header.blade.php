        ...
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          <ul class="list-unstyled">
            <li class="dropdown-item ">
              <a href="#" class="ms-0 text-decoration-none pe-7 py-2 border-0 btn btn-link text-black" onclick="event.preventDefault(); document.getElementById('logout-form').submit()">
                <i class="me-2 icon-md" data-feather="user"></i>
                <span class="align-middle">{{ Auth::user()->name }} ({{ Auth::user()->username }})</span>
           ...
           <ul class="list-unstyled">
            <li class="dropdown-item ">
           <button class="ms-0 text-decoration-none pe-7 py-2 border-0 btn btn-link" onclick="window.location.href = '{{ route('myaccount') }}'">
          ...
          <ul class="list-unstyled">
            <li class="dropdown-item ">
              <button class=" ms-0 text-decoration-none pe-7 py-2 border-0 btn btn-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit()">
                ...
                <span class="align-middle" onclick="document.getElementById('logout').submit();">Log Out</span>
                    <form id="logout" action="{{ route('logout') }}" method="post">@csrf</form>
              </button>
            </li>
          </ul>
