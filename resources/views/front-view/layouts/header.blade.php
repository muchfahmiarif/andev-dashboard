    ...
    <div class="navbar-content">
        ...
        <ul class="navbar-nav">
            <li class="nav-item flex-wrap">
                <p id="clock" class="text-nowrap text-center align-middle nav-link mb-0 fs-5"
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="notificationDropdown" role="button"
                ...
                <div class="dropdown-menu p-0" aria-labelledby="notificationDropdown">
                    <div class="px-3 py-2 d-flex align-items-center justify-content-between border-bottom gap-3">
                        ...
                        <a href="https://helpdesk.aryanoble.co.id/" class="badge bg-light text-dark"
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <ul class="list-unstyled">
                        <li class="dropdown-item ">
                            <a href="#"
                                class="ms-0 text-decoration-none pe-7 py-2 border-0 btn btn-link text-black"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit()">
                                <i class="me-2 icon-md" data-feather="user"></i>
                                <span class="align-middle">{{ Auth::user()->name }}
                    ...
                    <ul class="list-unstyled">
                        <li class="dropdown-item ">
                            <button class="ms-0 text-decoration-none pe-7 py-2 border-0 btn btn-link"
                                onclick="window.location.href = '{{ route('myaccount') }}'">
                                <i class="fas fa-cog me-2"></i>
                                <span class="align-middle">Setting Account</span>
                            </button>
                        </li>
                    </ul>
                    ...
                    <ul class="list-unstyled">
                        <li class="dropdown-item ">
                            <button class=" ms-0 text-decoration-none pe-7 py-2 border-0 btn btn-link"
                                ...
                                <span class="align-middle" onclick="document.getElementById('logout').submit();">Log
                                    Out</span>
                                <form id="logout" action="{{ route('logout') }}" method="post">@csrf</form>
                            </button>
                        </li>
