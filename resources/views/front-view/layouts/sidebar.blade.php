    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item {{ Request::is('development-journey*') ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#development-journey" role="button"
                    aria-expanded="{{ Request::is(['development-journey/*']) ? 'true' : 'false' }}"
                    aria-controls="development-journey">
                    <i class="link-icon" data-feather="command"></i>
                    <span class="link-title">Development Journey</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse {{ Request::is(['development-journey/*']) ? 'show' : '' }}"
                    id="development-journey">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('/development-journey/eksternal') }}"
                                class="nav-link {{ Request::is(['development-journey/eksternal*']) ? 'active' : '' }}">Eksternal</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/development-journey/finish_good') }}"
                                class="nav-link {{ Request::is(['development-journey/finish_good*']) ? 'active' : '' }}">Finish
                                Good</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/development-journey/mikrobiologi') }}"
                                class="nav-link {{ Request::is(['development-journey/mikrobiologi*']) ? 'active' : '' }}">Mikrobiologi</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/development-journey/raw_material') }}"
                                class="nav-link {{ Request::is(['development-journey/raw_material*']) ? 'active' : '' }}">Raw
                                Material</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item {{ Request::is(['rpv-riv/*']) ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#rpv-riv" role="button"
                    aria-expanded="{{ Request::is(['rpv-riv/*']) ? 'true' : 'false' }}" aria-controls="rpv-riv">
                ...
                <div class="collapse {{ Request::is(['rpv-riv/*']) ? 'show' : '' }}" id="rpv-riv">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('/rpv-riv/eksternal') }}"
                                class="nav-link {{ Request::is(['rpv-riv/eksternal']) ? 'active' : '' }}">Eksternal</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rpv-riv/finish_good') }}"
                                class="nav-link {{ Request::is(['rpv-riv/finish_good']) ? 'active' : '' }}">Finish
                                Good</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rpv-riv/mikrobiologi') }}"
                                class="nav-link {{ Request::is(['rpv-riv/mikrobiologi']) ? 'active' : '' }}">Mikrobiologi</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rpv-riv/raw_material') }}"
                                class="nav-link {{ Request::is(['rpv-riv/raw_material']) ? 'active' : '' }}">Raw
                                Material</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item {{ Request::is(['report-analysis/*']) ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#report-analysis" role="button"
                    aria-expanded="{{ Request::is(['report-analysis/*']) ? 'true' : 'false' }}"
                    aria-controls="report-analysis">
                ...
                <div class="collapse {{ Request::is(['report-analysis/*']) ? 'show' : '' }}" id="report-analysis">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('/report-analysis/ShowFormReportAnalysis') }}"
                                class="nav-link {{ Request::is(['report-analysis/ShowFormReportAnalysis']) ? 'active' : '' }}">Create
                                Report</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/report-analysis/finish_good') }}"
                                class="nav-link {{ Request::is(['report-analysis/finish_good']) ? 'active' : '' }}">Finish
                                Good</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/report-analysis/mikrobiologi') }}"
                                class="nav-link {{ Request::is(['report-analysis/mikrobiologi']) ? 'active' : '' }}">Mikrobiologi</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/report-analysis/raw_material') }}"
                                class="nav-link {{ Request::is(['report-analysis/raw_material']) ? 'active' : '' }}">Raw
                                Material</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/report-analysis/stabilita') }}"
                                class="nav-link {{ Request::is(['report-analysis/stabilita']) ? 'active' : '' }}">Stabilita</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="nav-item {{ Request::is(['lka/*']) ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#lka" role="button"
                    aria-expanded="{{ Request::is(['lka/*']) ? 'true' : 'false' }}" aria-controls="lka">
                ...
                <div class="collapse {{ Request::is(['lka/*']) ? 'show' : '' }}" id="lka">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('/lka/finish_good') }}"
                                class="nav-link {{ Request::is(['lka/finish_good']) ? 'active' : '' }}">Finish
                                Good</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/lka/mikrobiologi') }}"
                                class="nav-link {{ Request::is(['lka/mikrobiologi']) ? 'active' : '' }}">Mikrobiologi</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/lka/raw_material') }}"
                                class="nav-link {{ Request::is(['lka/raw_material']) ? 'active' : '' }}">Raw
                                Material</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/lka/stabilita') }}"
                                class="nav-link {{ Request::is(['lka/stabilita']) ? 'active' : '' }}">Stabilita</a>
                        </li>
                    </ul>
                </div>
            </li>
