      ...
      <div class="card-body">
          ...
          <div class="row">
              <div class="mb-3 col-md-6">
                  ...
                  <input class="form-control" type="text" id="firstName" name="firstName" value="{{ Auth::user()->username }}" disabled />
              </div>
              <div class="mb-3 col-md-6">
                  <label for="address" class="form-label">Email</label>
                  <input type="text" class="form-control" id="address" name="address" value="{{ Auth::user()->email }}" disabled/>
              </div>
              <div class="mb-3 col-md-6">
                  <label for="email" class="form-label">Nama Lengkap</label>
                  <input class="form-control" type="text" id="email" name="email"value="{{ Auth::user()->name }}" disabled>
              </div>
              <!--<div class="mb-3 col-md-6">-->
            ...
            <a href="#" title="Approval" class="btn btn-primary deactivate-account text-white" data-bs-toggle="modal"
            data-bs-target="#update">Changes Password</i></a>
          </div>
      </div>
    </div>
  </div>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" id="update_user" action="{{ route('myaccount.updatePassword') }}" method="post">
                                                @csrf
                                                <div class="form-group row">
                                                  <label for="current_password" class="col-sm-4 col-form-label">{{ __('Password Saat Ini') }}</label>
                                                  <div class="col-sm-8">
                                              ...
                                              <br>
                                              <div class="form-group row">
                                                  <label for="new_password_confirmation" class="col-sm-4 col-form-label">{{ __('Konfirm Password') }}</label>
                                                  <div class="col-sm-8">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                          ...
                                          <button type="submit" class="btn btn-primary"  onclick="document.getElementById('update_user').submit();">{{ __('Submit') }}</button>
                                      </div>
                                    </div>
                                </div>
                            </div>
