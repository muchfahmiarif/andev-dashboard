        ...
        <div class="card mb-4">
            <div class="card-header">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item"><a class="nav-link active" class="btn btn-danger btn-xs" data-bs-toggle="modal"
                            data-bs-target="#delete"><i class="bx bx-user me-1"></i> Create Account</a></li>
                </ul>
            </div>
            <div class="card">
                                ...
                                @foreach ($users as $key => $d)
                                    ...
                                    <tr>
                                        ...
                                        <td style=""class="text-center align-middle ">
                                            ...
                                            <button title="Finish Case" type="button" class="btn btn-danger btn-xs"
                                    ...
                                    <div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel"
                                        aria-hidden="true" id="delete{{ $d->id }}">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @if (count($users) > 0)
                                                        <form role="form" id="delete-form"
                                                            action="{{ route('user_delete') }}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                ...
                                                                <button id="button-save" type="submit"
                                                                    class="btn btn-danger">{{ __('Ya, hapus') }}</button>
                                                            </div>
                                                        </form>
                                                </div>
                                            @else
