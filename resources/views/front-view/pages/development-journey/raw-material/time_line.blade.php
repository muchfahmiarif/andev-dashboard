  ...
  <div class="row py-2">
    <div class="col-md-6">
     <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><p  href="{{ url('#') }}"> <a style="color:#000000" href="/development-journey/raw_material">Raw Material</a> / <a style="color:#000000" href="/development-journey/raw_material?nama_item={{ Request::get('nama_item') }}"> {{ Request::get('nama_item') }}</a> / <b> {{ Request::get('category') }}</b></p></li>
          </ol>
        </nav>
    </div>
  </div>
