                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <p href="{{ url('#') }}"> <a style="color:#000000"
                                href="/development-journey/finish_good">Finish Good</a> /<b>
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="cursor: pointer"
                                onclick="window.location.href='finish_good/finish_good_timeline?nama_item={{ $d->nama_item }}&category={{ $d->zat_aktif }}'">
                                {{ $d->zat_aktif }}</h5>
                            <p class="card-text">Nama Product : {{ $d->nama_item }} </p>
                            <a onclick="window.location.href='finish_good/finish_good_timeline?nama_item={{ $d->nama_item }}&category={{ $d->zat_aktif }}'"
