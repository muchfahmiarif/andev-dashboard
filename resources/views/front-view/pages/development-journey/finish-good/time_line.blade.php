                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <p href="{{ url('#') }}"> <a style="color:#000000"
                                href="/development-journey/finish_good">Finish Good</a> / <a style="color:#000000"
                                            ...
                                            <div>
                                                <div class="hstack">
                                                    <a style="cursor: pointer;" class="title text-decoration-none"
                                                        onclick="window.location.href='finish_good_timeline/detail?nama_item={{ $d->nama_item }}&category={{ $d->zat_aktif }}&time_line={{ $d->time_line }}'">{{ $d->time_line }}</a>
