    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <p href="{{ url('#') }}">
                    <a style="color:#000000" href="/development-journey/finish_good">Finish Good</a> /
                    <a style="color:#000000"
                        href="/development-journey/finish_good?nama_item={{ Request::get('nama_item') }}">
                        {{ Request::get('nama_item') }}</a> /
                    <a style="color:#000000"
                        href="/development-journey/finish_good/finish_good_timeline?nama_item={{ Request::get('nama_item') }}&category={{ Request::get('category') }}">{{ Request::get('category') }}</a>
                    /
