...
<nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <a style="color:#000000" href="/development-journey/mikrobiologi?nama_item={{ Request::get('nama_item') }}"> {{ Request::get('nama_item') }}</a> / 
            <a style="color:#000000" href="/development-journey/mikrobiologi/mikrobiologi_timeline?nama_item={{ Request::get('nama_item') }}&category={{ Request::get('category') }}">{{ Request::get('category') }}</a> / 
