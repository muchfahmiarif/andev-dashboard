...
<div class="container" style="border-radius: 15px;">
    <div class="card ">
        ...
        <div class="card-body">
            <form role="form" id="save"  action="{{ route('addLKA') }}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" id="id_develop" name="id_develop">
                <input type="hidden" id="user_id" name="user_id">
                <div class="form-group row">
                    <label for="contact_person" class="col-sm-4 col-form-label">{{ __('Category Develop Journey') }}</label>
                      <div class="col-sm-8">
                          <select class="form-control select2" style="width: 100%;" id="jenis_journey" name="jenis_journey">
                              <option value="" disabled selected>Option Develop Journey</option>
                              <option value="Finish Good" {{ $jenis_journey == 'Finish Good' ? 'selected' : '' }}>Finish Good</option>
                              <option value="External" {{ $jenis_journey == 'External' ? 'selected' : '' }}>External</option>
                              <option value="Raw Material" {{ $jenis_journey == 'Raw Material' ? 'selected' : '' }}>Raw Material</option>
                              <option value="Mikrobiologi" {{ $jenis_journey == 'Mikrobiologi' ? 'selected' : '' }}>Mikrobiologi</option>
                          </select>
                          @error('jenis_journey')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_item" name="nama_item"  value="{{ old('nama_item') }}">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="no_lka" name="no_lka"   value="{{ old('no_lka') }}">
                    </div>
                </div>
                <br>
                <div class="form-group row">
