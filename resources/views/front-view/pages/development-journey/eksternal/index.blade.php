                ...
                <div id="content">
                  <ul class="timeline">
                    <li class="event" data-date="2 Days Ago">
                      <div>
                        <div class="hstack">
                          <a class="title text-decoration-none" href="{{ url('/development-journey/eksternal/detail') }}">Registration</a>
                    ...
                    <li class="event" data-date="9 Month Ago">
                      <div>
                        <div class="hstack">
                          <a class="title text-decoration-none" href="{{ url('/development-journey/eksternal/detail') }}">BPO ex Global</a>
                    ...
                    <li class="event" data-date="Apr 2018">
                      <div>
                        <div class="hstack gap-3">
                          <a class="title text-decoration-none" href="{{ url('/development-journey/eksternal/detail') }}">BPO ex Alchem</a>
                    ...
                    <li class="event" data-date="Apr 2015">
                      <div>
                        <div class="hstack gap-3">
                          <a class="title text-decoration-none" href="{{ url('/development-journey/eksternal/detail') }}">BPO</a>
                ...
                <div id="content">
                  <ul class="timeline">
                    ...
                    <li class="event" data-date="9 Month Ago">
                      <div>
                        <div class="hstack">
                          <a class="title text-decoration-none" href="{{ url('/development-journey/eksternal/detail') }}">Adapalene</a>
                          <p class="ms-auto badge bg-danger">Pending</p>
                        </div>
                        <p>Perubahan prosedur kerja sesuai USP 44 dan perubahan format dokumen</p>
                      </div>
