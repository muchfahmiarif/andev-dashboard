...
@section('content')
 <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <a style="color:#000000" href="/development-journey/eksternal?nama_item={{ Request::get('nama_item') }}"> {{ Request::get('nama_item') }}</a> / 
            <a style="color:#000000" href="/development-journey/eksternal/eksternal_timeline?nama_item={{ Request::get('nama_item') }}&category={{ Request::get('category') }}">{{ Request::get('category') }}</a> / 
