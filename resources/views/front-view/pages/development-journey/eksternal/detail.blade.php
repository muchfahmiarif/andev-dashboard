    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <p href="{{ url('#') }}">
                    <a style="color:#000000" href="/development-journey/eksternal">Eksternal</a> /
                    <a style="color:#000000"
                        href="/development-journey/eksternal?nama_item={{ Request::get('nama_item') }}">
                        {{ Request::get('nama_item') }}</a> /
                    <a style="color:#000000"
                        href="/development-journey/eksternal/eksternal_timeline?nama_item={{ Request::get('nama_item') }}&category={{ Request::get('category') }}">{{ Request::get('category') }}</a>
                    /
                            ...
                            <form role="form" id="approve-form" action="{{ route('addDocument') }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea type="text" class="form-control" id="keterangan" name="keterangan"
                                            value="{{ $data['pketerangan'] }}">{{ $data['pketerangan'] }}</textarea>
                                    </div>
                                </div>
                                {{-- <br>
                                    <div class="form-group row">
                                ...
                                <div class="d-flex justify-content-end gap-3">
                                    <button type="button" data-bs-dismiss="modal" aria-label="Close"
                                        class="btn btn-danger text-white close">Batal</button>
                                    <button id="button-save" type="submit" class="btn btn-primary text-white">Simpan
                                        perubahan</button>
                                </div>
                            </form>
                        </div>
