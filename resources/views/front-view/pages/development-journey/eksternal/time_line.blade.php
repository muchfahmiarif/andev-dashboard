                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <p href="{{ url('#') }}"> <a style="color:#000000"
                                href="/development-journey/eksternal">Eksternal</a> / <a style="color:#000000"
                                            ...
                                            <div>
                                                <div class="hstack">
                                                    <a style="cursor: pointer;" class="title text-decoration-none"
                                                        onclick="window.location.href='eksternal_timeline/detail?nama_item={{ $d->nama_item }}&category={{ $d->zat_aktif }}&time_line={{ $d->time_line }}'">{{ $d->time_line }}</a>
                            ...
                            <div class="modal-body">
                                <form role="form" id="approve-form" action="{{ route('addTimeline') }}"
                                    ...
                                    <div class="form-group row">
                                        <label for="time_line"
                                            class="col-sm-4 col-form-label">{{ __('Title Timeline') }}</label>
                                        <div class="col-sm-8">
                ...
                <div class="modal-body">
                    <form role="form" id="approve-form" action="{{ route('addTimeline') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input id="input-body"
                                    style="opacity: 0; width: 0; position: absolute; top: 37%; left: 36%" name="body"
                                    required="required">
