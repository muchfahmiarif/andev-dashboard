...
<div class="row py-2">
  <div class="col-md-5">
    <h4>
      <span class="text-muted fw-light">Tables /</span> Eksternal
    </h4>
  </div>
...
<div class="card">
    <div class="card-header">
        <div class="container" style="display: flex; justify-content: space-between;">
            <div>
                <a onclick="window.location.href='{{ route('ShowFormRPVRIV', ['jenis_kegiatan' => 'External']) }}'" class="btn btn-primary text-white" style="width: 200px; text-align: center; margin-right: 10px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" id="approve-form" action="{{ route('export_report') }}" method="post">
                        @csrf
                        <input type="hidden" name="jenis_report" id="jenis_report" value="External">
                        <div class="form-group row">
