...
<div class="card">
    <div class="card-header">
        <div class="container" style="display: flex; justify-content: space-between;">
            <div>
                <a onclick="window.location.href='{{ route('ShowFormRPVRIV', ['jenis_kegiatan' => 'Raw Material']) }}'" class="btn btn-primary text-white" style="width: 200px; text-align: center; margin-right: 10px;">
          ...
          <table class="table">
            ...
            @if (count($products) > 0)
                @foreach ($products as $key => $d)
                  ...
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(1, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(2, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(3, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(4, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(5, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(6, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(7, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(8, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(9, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(10, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(11, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $rencanaArray = explode(',', $data['rencana']); if (in_array(12, $rencanaArray)) {  echo '#00588b';  } @endphp"></td>
                  <td rowspan="2" class="text-center align-middle"> {{ $data['keterangan'] }} </td>
                   @php
                      ...
                      sort($aktual);
                      $status = 'Effective';
                      if (count(array_intersect($rencana, $aktual)) === count($rencana) && count($rencana) > count($aktual)) {
                          $status = 'Effective';
              ...
              <td rowspan="2" class="text-center align-middle">{{ $status }}</td>
                ...
                <tr>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(1, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(2, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(3, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(4, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(5, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(6, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(7, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(8, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(9, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(10, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(11, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                  <td class="text-center align-middle" style="background-color:@php  $aktualArray = explode(',', $data['aktual']); if (in_array(12, $aktualArray)) {  echo '#f76300';  } @endphp"></td>
                </tr>
                <div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" id="approve1{{ $d->id_kegiatan }}">
                  <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              @if (count($products) > 0)
                              <form role="form" id="delete" action="{{ route('approve_1') }}" method="post">
                                @csrf
                                ...
                                <div class="modal-footer justify-content-between">
                                    ...
                                    <button id="button-save" type="submit" class="btn btn-primary text-white">{{ __('Submit') }}</button>
                                </div>
                            </form>
                          </div>
                  ...
                  <div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" id="approve2{{ $d->id_kegiatan }}">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Action</h5>
                ...
                <div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" id="delete{{ $d->id_kegiatan }}">
                  <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Action</h5>
