...
<div class="container" style="border-radius: 15px;">
    <div class="card ">
        ...
        <div class="card-body">
            <form role="form" id="save"  action="{{ route('addReport') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    <label for="contact_person" class="col-sm-4 col-form-label">{{ __('Jenis Report') }}</label>
                      <div class="col-sm-8">
                          <select class="form-control select2" style="width: 100%;" id="jenis_report"
                              name="jenis_report">
                              <option value="" disabled selected>Option Report</option>
                              <option value="Finish Good" {{ $jenis_report == 'Finish Good' ? 'selected' : '' }}>Finish Good</option>
                              <option value="Stabilita" {{ $jenis_report == 'Stabilita' ? 'selected' : '' }}>Stabilita</option>
                              <option value="Raw Material" {{ $jenis_report == 'Raw Material' ? 'selected' : '' }}>Raw Material</option>
                              <option value="Mikrobiologi" {{ $jenis_report == 'Mikrobiologi' ? 'selected' : '' }}>Mikrobiologi</option>
                          </select>
                          @error('jenis_report')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_item" name="nama_item"  value="{{ $amrData->nama_item ?? old('nama_item') }}"  > 
                    </div>
                </div>
                <br>
                 <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="supplier" name="supplier"  value="{{ $amrData->supplier ?? old('supplier') }}"  > 
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="kode_racikan" name="kode_racikan"  value="{{ $amrData->kode_racikan ?? old('kode_racikan') }}"  > 
                    </div>
                    <label for="no_bets" class="col-sm-1 col-form-label">{{ __('No Bets') }}</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="no_bets" name="no_bets"  value="{{ $amrData->no_bets ?? old('no_bets') }}"  > 
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control" id="tgl_analisa" name="tgl_analisa"  value="{{ old('tgl_analisa') }}">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control" id="tgl_est" name="tgl_est"   value="{{ old('tgl_est') }}">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control" id="tgl_selesai_report" name="tgl_selesai_report"  value="{{ old('tgl_selesai_report') }}">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control select2" style="width: 100%;" id="nama_analis" name="nama_analis">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="file"  class="form-control" id="file_upload" name="file_upload" placeholder="Enter Note" value="{{ old('file_upload') }}">
                        @error('file_upload')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea type="text"  class="form-control" id="keterangan" name="keterangan" placeholder="Masukan Keterangan" value="{{ old('keterangan') }}"></textarea>
                        @error('keterangan')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
