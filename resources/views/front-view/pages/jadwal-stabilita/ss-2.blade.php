                ...
                <table id="example" class="table hover stripe">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="#" class="text-decoration-none btn btn-warning btn-sm"><i data-feather="edit"
                                        class="text-dark"></i></a>
                        ...
                        <tr>
                            ...
                            <td class="align-center">...</td>
                            <td>
                                <a href="#" class="text-decoration-none btn btn-warning btn-sm"><i
                                        data-feather="edit" class="text-dark"></i></a>
                                <button class="btn btn-danger btn-sm">
                                    <i data-feather="trash" class="text-dark"></i>
                                </button>
                            </td>
