...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="container" style="display: flex; justify-content: space-between;">
                <div>
                    <a onclick="window.location.href='{{ route('ShowFormInstrument') }}'"
                ...
                <thead>
                    <tr class="text-center">
                        <th class="text-center align-middle"
                            style="background-color:#bbbbbb; position: sticky;  top: 0; left:0px; z-index: 999;  min-width:50px;"
                            rowspan="2">No</th>
                        <th class="text-center align-middle"
                            style="background-color:#bbbbbb; position: sticky;  top: 0; left: 50px; z-index: 999;  min-width:200px;"
                            rowspan="2">Alat Instrument</th>
                        <th class="text-center align-middle"
                            style="background-color:#bbbbbb; position: sticky;  top: 0; left: 250px; z-index: 999;  min-width:200px;"
                            rowspan="2">No. Asset</th>
                        <th class="text-center align-middle" style="background-color:#74c3b0; position: sticky;  top: 0;"
                            colspan="2">Jan</th>
                        <th class="text-center align-middle" style="background-color:#7fcfd1; position: sticky;  top: 0;"
                            colspan="2">Feb</th>
                        <th class="text-center align-middle" style="background-color:#fed2c7; position: sticky;  top: 0;"
                            colspan="2">Mar</th>
                        <th class="text-center align-middle" style="background-color:#b9e3d7; position: sticky;  top: 0;"
                            colspan="2">Apr</th>
                        <th class="text-center align-middle" style="background-color:#abe1e4; position: sticky;  top: 0;"
                            colspan="2">Mei</th>
                        <th class="text-center align-middle" style="background-color:#ffced2; position: sticky;  top: 0;"
                            colspan="2">Jun</th>
                        <th class="text-center align-middle" style="background-color:#c6e9e3; position: sticky;  top: 0;"
                            colspan="2">Jul</th>
                        <th class="text-center align-middle" style="background-color:#c5eff1; position: sticky;  top: 0;"
                            colspan="2">Aug</th>
                        <th class="text-center align-middle" style="background-color:#ffbec4; position: sticky;  top: 0;"
                            colspan="2">Sep</th>
                        <th class="text-center align-middle" style="background-color:#e2ede9; position: sticky;  top: 0;"
                            colspan="2">Oct</th>
                        <th class="text-center align-middle" style="background-color:#d8aed4; position: sticky;  top: 0;"
                            colspan="2">Nov</th>
                        <th class="text-center align-middle" style="background-color:#ffa2ac; position: sticky;  top: 0;"
                            colspan="2">Dec</th>
                        <th class="text-center align-middle" style="background-color:#bbbbbb; position: sticky;  top: 0;"
                    ...
                    <tr>
                        <th class="text-center align-middle "
                            style="background-color:#74c3b0; position: sticky;  top: 0; ">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#74c3b0; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#7fcfd1; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#7fcfd1; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#fed2c7; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#fed2c7; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#b9e3d7; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#b9e3d7; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#abe1e4; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#abe1e4; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#ffced2; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#ffced2; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#c6e9e3; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#c6e9e3; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#c5eff1; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#c5eff1; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#ffbec4; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#ffbec4; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#e2ede9; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#e2ede9; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#d8aed4; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#d8aed4; position: sticky;  top: 0;">Perform</th>
                        <th class="text-center align-middle "
                            style="background-color:#ffa2ac; position: sticky;  top: 0;">Kalibrasi</th>
                        <th class="text-center align-middle "
                            style="background-color:#ffa2ac; position: sticky;  top: 0;">Perform</th>
                    </tr>
                </thead>
                        ...
                        @foreach ($products as $key => $d)
                            ...
                            <tr>
                                <td class="text-center align-middle "
                                    style="position: sticky; background-color: #f2f2f2;  left: 0;">{{ $startNumber++ }}
                                </td>
                                <td
                                    style="min-width: 200px; background-color: #f2f2f2; position: sticky;  left: 50px;"class="text-center align-middle  ">
                                    {{ $data['alat_instrument'] }}
                                </td>
                                <td
                                    style="min-width: 200px; background-color: #f2f2f2; position: sticky;  left: 250px;"class="text-center align-middle ">
                                    {{ $data['no_asset'] }}
                                </td>
                                ...
                                <td style="min-width: 100px;"class="text-center align-middle ">
                                    <a title="Edit Data" type="button" class="btn btn-secondary btn-sm text-white"
                                        data-bs-toggle="modal" data-bs-target="#update_data{{ $d->id_instrument }}"><i
                                            class="fas fa-edit"></i></a>
                                    <a title="Delete Data" type="button" class="btn btn-danger btn-sm text-white"
                                        data-bs-toggle="modal" data-bs-target="#delete{{ $d->id_instrument }}"><i
                                            class="fas fa-trash"></i></a>
                                </td>

                            </tr>
                            <div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel"
                                aria-hidden="true" id="remarks{{ $d->id_instrument }}">
    ...
    <div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
        id="update_data{{ $d->id_instrument }}">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if (count($products) > 0)
                        <form role="form" id="approve-form" action="{{ route('update_instrument') }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="id_instrument" name="id_instrument" value="{{ $data['pid'] }}">
                            <div class="form-group row">
                                <label for="alat_instrument"
                                    class="col-sm-4 col-form-label">{{ __('Alat Instrument') }}</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="alat_instrument"
                                        name="alat_instrument" value="{{ $data['alat_instrument'] }}">
                                </div>
                            </div>
                            <br>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi1" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi1'] === 'Ya' ? 'checked' : '' }}>
                                ...
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi1" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi1'] === 'Tidak' ? 'checked' : '' }}>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa1" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa1'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa1" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa1'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi2" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi2'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi2" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi2'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa2" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa2'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa2" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa2'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi3" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi3'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi3" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi3'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa3" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa3'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa3" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa3'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi4" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi4'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi4" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi4'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa4" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa4'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa4" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa4'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi5" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi5'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi5" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi5'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa5" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa5'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa5" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa5'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi6" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi6'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi6" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi6'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa6" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa6'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa6" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa6'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi7" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi7'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi7" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi7'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa7" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa7'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa7" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa7'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi8" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi8'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi8" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi8'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa8" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa8'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa8" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa8'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi9" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi9'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi9" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi9'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa9" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa9'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa9" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa9'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi10" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi10'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi10" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi10'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa10" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa10'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa10" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa10'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa11" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa11'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa11" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa11'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi12" id="addFieldBtnPM"
                                        value="Ya" {{ $data['kalibrasi12'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="kalibrasi12" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['kalibrasi12'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa12" id="addFieldBtnPM"
                                        value="Ya" {{ $data['performa12'] === 'Ya' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="addFieldBtnPM">Ya</label>
                                </div>
                                <div class=" col-sm-3">
                                    <input class="form-check-input" type="radio" name="performa12" id="addFieldBtnRM"
                                        value="Tidak" {{ $data['performa12'] === 'Tidak' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                </div>
                            </div>
                            <hr>
