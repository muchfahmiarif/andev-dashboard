        ...
        <div class="px-72 space-y-4 my-10">
            <details class="group [&_summary::-webkit-details-marker]:hidden " open>
                ...
                <p class="px-4 mt-4 leading-relaxed text-gray-700 whitespace-pre-line bg-gray-50 rounded-lg">
                    Alat berbasis web canggih yang dibuat untuk mengoptimalkan kinerja, penyimpanan data, dan efektivitas
                    aplikasi web secara keseluruhan, dasbor ini berfungsi sebagai pusat kontrol terpusat bagi user untuk
                    memantau, menganalisis, dan memastikan berkelanjutan proyek - proyek yang sedang di handle.
            </details>
