...
<body class="flex flex-col h-screen">
  <header class="bg-white shadow">
      ...
      <nav class="hidden gap-12 lg:flex">
        <a href="/home" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700" target="_blank">Home</a>
        <a href="#" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700" target="_blank">Halaman Edit</a>
        <a href="#" class="text-lg font-semibold text-gray-600 transition duration-100 hover:animate-text hover:bg-gradient-to-r from-teal-500 hover:via-purple-500 hover:to-orange-500 hover:bg-clip-text hover:text-transparent hover:font-black  active:text-indigo-700">Stock WS / RS</a>
        <a href="#" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700" target="_blank">Tentang</a>
      </nav>
      <!-- nav - end -->

      <!-- buttons - start -->
      <a href="https://helpdesk.aryanoble.co.id/" class="hidden rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-500 hover:text-white active:text-indigo-100 focus-visible:ring active:text-gray-700 md:text-base lg:inline-block" target="_blank">Contact IT Genero</a>
        ...
        <div class="splide__slider">
          <div class="splide__track">
            <ul class="splide__list">
              ...
              <li class="splide__slide">
                <img src="{{ asset('img/genero.png') }}" alt="Genero" loading="lazy" class="w-full object-cover">
              </li>
