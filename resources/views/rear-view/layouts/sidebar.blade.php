        ...
        <div class="collapse {{ Request::is(['rear-view/rpv-riv/*']) ? 'show' : '' }}" id="rpv-riv">
          <ul class="nav sub-menu">
            ...
            <li class="nav-item {{ Request::is(['rear-view/report-analysis/*']) ? 'active' : '' }}">
                ...
                <div class="collapse {{ Request::is(['rear-view/report-analysis/*']) ? 'show' : '' }}"
                    id="report-analysis">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/report-analysis/finish-good') }}"
                                class="nav-link {{ Request::is(['rear-view/report-analysis/finish-good']) ? 'active' : '' }}">Finish
                                Good</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/report-analysis/mikrobiologi') }}"
                                class="nav-link {{ Request::is(['rear-view/report-analysis/mikrobiologi']) ? 'active' : '' }}">Mikrobiologi</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/report-analysis/raw-material') }}"
                                class="nav-link {{ Request::is(['rear-view/report-analysis/raw-material']) ? 'active' : '' }}">Raw
                                Material</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/report-analysis/stabilita') }}"
                                class="nav-link {{ Request::is(['rear-view/report-analysis/stabilita']) ? 'active' : '' }}">Stabilita</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="nav-item {{ Request::is(['rear-view/jadwal-stabilita/*']) ? 'active' : '' }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#jadwal-stabilita" role="button"
                    aria-expanded="{{ Request::is(['jadwal-stabilita/*']) ? 'true' : 'false' }}"
                    aria-controls="jadwal-stabilita">
                ...
                <div class="collapse {{ Request::is(['jadwal-stabilita/*']) ? 'show' : '' }}" id="jadwal-stabilita">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/jadwal-stabilita/ss-1') }}"
                                class="nav-link {{ Request::is(['rear-view/jadwal-stabilita/ss-1']) ? 'active' : '' }}">SS
                                1</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/jadwal-stabilita/ss-2') }}"
                                class="nav-link {{ Request::is(['rear-view/jadwal-stabilita/ss-2']) ? 'active' : '' }}">SS
                                2</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item {{ Request::is(['rear-view/lka/*']) ? 'active' : '' }}">
                ...
                <div class="collapse {{ Request::is(['rear-view/lka/*']) ? 'show' : '' }}" id="lka">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/lka/finish-good') }}"
                                class="nav-link {{ Request::is(['rear-view/lka/finish-good']) ? 'active' : '' }}">Finish
                                Good</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/lka/mikrobiologi') }}"
                                class="nav-link {{ Request::is(['rear-view/lka/mikrobiologi']) ? 'active' : '' }}">Mikrobiologi</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/lka/raw-material') }}"
                                class="nav-link {{ Request::is(['rear-view/lka/raw-material']) ? 'active' : '' }}">Raw
                                Material</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/rear-view/lka/stabilita') }}"
                                class="nav-link {{ Request::is(['rear-view/lka/stabilita']) ? 'active' : '' }}">Stabilita</a>
                        </li>
                    </ul>
                </div>
            </li>
