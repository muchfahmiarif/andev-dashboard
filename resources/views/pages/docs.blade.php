...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Responsive Laravel Admin &amp; Dashboard Template based on Bootstrap 5 Documentation" />
    <meta name="author" content="Andev Dashboard" />
    <meta
      name="keywords"
      content="andev dashboard" />
  ...
  ├── documentation
        ...
        <div class="grid-margin">
          ...
          <p class="mb-3">
            <strong>4.</strong> Copy <code>.env.example</code> file and create duplicate. Use <code>cp</code> command for Linux or Mac user.
          </p>
          ...
          <p>
            The RTL does not enabled by default. It can be easily setup with a <a href="https://rtlcss.com/" target="_blank">RTLCSS</a> webpack
            plugin.
          </p>
          ...
          <p><strong>2.</strong> Uncomment the following two lines in the webpack.mix.js file (~Line number 2 and 20 ).</p>
          ...
          <p class="mb-4">You will be able to get the bundle CSS with RTL by path: <code>[demo]/public/css/app.rtl.css</code>.</p>

          <p>
            <strong>4.</strong> Open the master.blade.php file from <code>[demo]/resources/views/layout/master.blade.php</code>. Change the file path
            to the RTL CSS path:
          </p>
          <ul class="mb-4">
            <li>From: <code>&lt;link href="{{ asset('css/app.css') }}" rel="stylesheet" /&gt;</code></li>
            <li>To RTL CSS: <code>&lt;link href="{{ asset('css/app.rtl.css') }}" rel="stylesheet" /&gt;</code></li>
          </ul>

          <p><strong>5.</strong> In the master.blade.php file, set <code>dir="rtl"</code> on the <code>html</code> element.</p>
          ...
          <p class="mb-3">The Dark sidebar (in Demo1) &amp; Dark header (in Demo3) are does not enabled by default.</p>
          <p class="mb-4">Add class to the <code>body</code> element as given below (in resources > views > layout > master.blade.php).</p>
          <ul>
            <li class="mb-2">For the dark sidebar (in Demo1), set <code>class="sidebar-dark"</code> on the <code>body</code> element.</li>
            <textarea rows="4" cols="50" class="code-non-editable"><body class="sidebar-dark"></textarea>
            <li class="mb-2">For the dark header (in Demo3), set <code>class="navbar-dark"</code> on the <code>body</code> element.</li>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td>Cropper.js</td>
                  <td><a href="https://github.com/fengyuanchen/cropperjs" target="_blank">https://github.com/fengyuanchen/cropperjs</a></td>
                </tr>
                <tr>
                  <td>Data Table</td>
                ...
                <tr>
                  <td>Flatpickr</td>
                  <td><a href="https://flatpickr.js.org/" target="_blank">https://flatpickr.js.org/</a></td>
                </tr>
                <tr>
                  <td>Flot Charts</td>
                ...
                <tr>
                  ...
                  <td>
                    <a href="https://omnipotent.net/jquery.sparkline/#s-about" target="_blank">https://omnipotent.net/jquery.sparkline/#s-about</a>
                  </td>
                </tr>
                <tr>
                  <td>jQuery Steps</td>
                  <td><a href="http://www.jquery-steps.com/GettingStarted" target="_blank">http://www.jquery-steps.com/GettingStarted</a></td>
                </tr>
                <tr>
                  <td>jQuery Tags Input Plugin</td>
                  <td>
                    <a href="https://www.npmjs.com/package/jquery-tags-input" target="_blank">https://www.npmjs.com/package/jquery-tags-input</a>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <a href="https://github.com/mdbootstrap/perfect-scrollbar" target="_blank">https://github.com/mdbootstrap/perfect-scrollbar</a>
                  </td>
                </tr>
                <tr>
                  <td>Pickr</td>
                  <td><a href="https://simonwep.github.io/pickr/" target="_blank">https://simonwep.github.io/pickr/</a></td>
                </tr>
                <tr>
                  <td>Popper Js</td>
                ...
                <tr>
                  <td>Easy MDE</td>
                  <td><a href="https://github.com/Ionaru/easy-markdown-editor" target="_blank">https://github.com/Ionaru/easy-markdown-editor</a></td>
                </tr>
                <tr>
                  <td>Sweetalert 2</td>
          ...
          <p class="mb-2">
            ...
            <a href="https://themeforest.net/item/nobleui-laravel-admin-template/25229169/support" target="_blank"
              >https://themeforest.net/item/nobleui-laravel-admin-template/25229169/support</a
            >
          ...
          <p class="mb-5 pb-5">
            If you liked our product, would you mind taking a few seconds to <b> write a review and ⭐️⭐️⭐️⭐️⭐️ rating </b> for us, please? It
            means a lot to us. You can review the product from the
            <a href="https://themeforest.net/downloads" target="_blank"> https://themeforest.net/downloads </a> page.
          </p>
